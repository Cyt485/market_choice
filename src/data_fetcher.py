...
class DataFetcher:
    ...
    def _get_hk_from_tencent(self) -> pd.DataFrame:
        ...
        hk_codes = [
            ...
            '09636', '09877', '09961', '06690', '01898', '00883',
            # 金融
            '00005', '02318', '01299', '03988', '01398', '02328', '06818', '06030',
            '03968', '03328', '06138', '06066', '06837', '06099', '06186',
            '06049', '06886', '06881', '03908', '03347', '06110', '06823', '06862',
            # 地产/基建
            '01109', '00688', '01113', '01997', '02007', '02238', '01238', '06808',
            '01918', '01929', '01972', '01928', '03333', '03380', '03377',
            '00683', '01038', '00817', '00884', '00960', '00914', '01186', '01238',
            # 消费/零售
            '09618', '09992', '09888', '09633', '06690', '09868', '02015',
            '01810', '02269', '09698', '09636', '09961', '09923', '09626', '06969',
            '00175', '01928', '01898', '00836', '00857', '00881', '00992', '01044',
            '01913', '09869', '09658', '09660', '06908', '09877', '09956', '09995',
            # 医药
            '02269', '01093', '01177', '01548', '01801', '06185', '09688', '02162',
            '01873', '01521', '02157', '02170', '02252', '02256', '02315', '02367',
            # 能源/资源
            '00883', '00857', '01898', '01193', '01208', '02382', '02899', '00881',
            '00998', '01088', '00902',
            # 电信
            '00762', '00728', '00941', '00992', '00788', '00852',
            # 其他知名港股
            '00002', '00003', '00006', '00008', '00012', '00014', '00016', '00017',
            '00019', '00066', '00101', '00144', '00151', '00270', '00288', '00371',
            '00386', '00522', '00662', '00669', '00708', '00751', '00753', '00823',
            '00836', '00852', '00864', '00880', '00908', '00914', '00939', '00941',
            '00966', '00981', '00992', '00995', '01038', '01044', '01055', '01065',
            '01071', '01083', '01088', '01109', '01113', '01128', '01138', '01171',
            '01186', '01193', '01208', '01211', '01238', '01258', '01288', '01299',
            '01313', '01336', '01339', '01347', '01359', '01378', '01382', '01398',
            '01478', '01548', '01585', '01618', '01635', '01658', '01691', '01766',
            '01772', '01787', '01797', '01800', '01801', '01810', '01812', '01813',
            '01816', '01821', '01833', '01848', '01873', '01876', '01877', '01880',
            '01882', '01888', '01890', '01896', '01897', '01898', '01910', '01918',
            '01919', '01928', '01929', '01951', '01958', '01963', '01972', '01988',
            '01997', '02005', '02007', '02009', '02013', '02015', '02018', '02020',
            '02038', '02057', '02096', '02098', '02121', '02137', '02157', '02162',
            '02170', '02238', '02252', '02256', '02269', '02282', '02315', '02318',
            '02328', '02331', '02338', '02367', '02382', '02400', '02500',
            '02600', '02601', '02607', '02628', '02688', '02689', '02727', '02768',
            '02800', '02822', '02823', '02828', '02899', '02911', '03328', '03347',
            '03360', '03377', '03380', '03383', '03606', '03618', '03638', '03690',
            '03800', '03808', '03888', '03898', '03900', '03908', '03968', '03988',
            '03993', '03996', '06030', '06049', '06060', '06066', '06088', '06098',
            '06099', '06110', '06138', '06158', '06160', '06169', '06178', '06185',
            '06186', '06198', '06690', '06806', '06808', '06818', '06823', '06837',
            '06862', '06865', '06868', '06881', '06886', '06908', '06928', '06969',
            '06993', '09626', '09633', '09636', '09658', '09660', '09688', '09698',
            '09866', '09868', '09869', '09877', '09888', '09923', '09956', '09961',
            '09988', '09992', '09995', '09999',
        ]
            ...
            try:
                ...
                for line in text.split('";'):
                    ...
                    try:
                        ...
                        price = float(parts[3]) if parts[3] else 0
                        change_pct = float(parts[32]) if len(parts) > 32 and parts[32] else 0
                        pe = float(parts[33]) if len(parts) > 33 and parts[33] and parts[33] != '0' else -1
                        turnover = float(parts[38]) if len(parts) > 38 and parts[38] else 0

                        # 市值：腾讯港股接口字段44为总市值（万元）
                        market_cap = 0
                        if len(parts) > 44 and parts[44]:
                            try:
                                market_cap = float(parts[44]) * 10000  # 万元转元
                            except:
                                market_cap = 0
    ...
    def get_financial_data(self, code: str, market: str = 'a') -> Dict:
        ...
        # 港股财务：云端环境无法稳定获取，直接跳过
        # 评分系统会对无财务数据的港股使用纯行情指标兜底
    ...
    def _get_a_cf_from_baostock(self, code: str) -> Dict:
        ...
        try:
            ...
            latest = cf_list[-1]
            try:
                op_cf = float(latest[8]) if len(latest) > 8 and latest[8] else 0
            except:
                op_cf = 0
